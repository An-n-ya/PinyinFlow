...
export default function Chat() {
    ...
    // Memoizing submit_pinyin to maintain a stable reference.
    // This allows InputArea to be wrapped in React.memo and prevents it
    // from re-rendering every time the messages state updates.
