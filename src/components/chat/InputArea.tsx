...
// Wrap InputArea in React.memo to prevent unnecessary re-renders when the parent Chat component
// updates its `messages` state (e.g., from frequent `tts-finished` or `audio-played` events).
// This optimization ensures the input area remains responsive during heavy message activity.
