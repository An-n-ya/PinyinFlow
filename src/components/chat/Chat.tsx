...
export default function Chat() {
    ...
    // Performance: Memoize play to prevent recreating the function on every render
    ...
    // Performance: Memoize submit_pinyin to avoid unnecessary re-renders of InputArea
