...
// Memoize InputArea to prevent unnecessary re-renders when the parent Chat
// component updates its messages state (e.g. from audio-played/tts-finished events).
