...
export default function Chat() {
    ...
    // useCallback is used here to provide a stable reference for the memoized InputArea
    // and to avoid unnecessary re-renders when the parent state (messages) changes.
    ...
    // useCallback provides a stable prop reference for the memoized InputArea component
