...
// Memoize InputArea to prevent unnecessary re-renders when the parent Chat component
// updates its message state frequently (e.g., during TTS and audio playback events).
