...
// Wrap in React.memo to prevent unnecessary re-renders when the parent Chat component
// updates its message list. This avoids rebuilding the complex PromptInput subtree.
// Expected Impact: 100% reduction in InputArea re-renders during message/audio updates.
