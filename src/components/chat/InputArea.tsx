...
// Wrap InputArea with React.memo to prevent unnecessary re-renders
// when the parent Chat component's state (like messages array) changes.
// Relies on stable onSendMessage prop passed from parent using useCallback.
