...
// ⚡ Bolt: Wrap InputArea with React.memo to prevent unnecessary re-renders when the parent Chat
// component's state (e.g. messages list) changes. This complex input UI only needs to re-render
// if its own props (onSendMessage) change.
