...
export default function Chat() {
    ...
    // ⚡ Bolt: Memoize the play function to maintain a stable reference and prevent
    // child components from unnecessarily re-rendering on Chat state updates.
    ...
    const submit_pinyin = useCallback(
        // ⚡ Bolt: Memoize submit_pinyin to maintain a stable reference for the onSendMessage
        // prop in InputArea, preventing unnecessary re-renders when messages update.
        (pinyin: string) => {
