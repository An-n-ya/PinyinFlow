...
// Memoized to prevent unnecessary re-renders when parent Chat component's messages state updates
// during frequent backend events (tts-finished, audio-played).
