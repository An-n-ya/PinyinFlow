...
// ⚡ Bolt: Wrapped InputArea in React.memo to prevent unnecessary re-renders.
// It will now only re-render when its props (like onSendMessage) change,
// improving typing performance when the Chat history updates.
