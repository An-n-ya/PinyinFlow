...
export default function Chat() {
    ...
    // Wrap submit_pinyin in useCallback to provide a stable reference for the memoized InputArea,
    // ensuring it doesn't re-render when Chat's `messages` state updates.
