...
export default function Chat() {
    ...
    // ⚡ Bolt: Memoize submit handler with useCallback to prevent recreation on every render,
    // which prevents the InputArea child component from unnecessarily re-rendering.
    const submit_pinyin = useCallback((pinyin: string) => {
