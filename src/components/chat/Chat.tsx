...
export default function Chat() {
    ...
    // Memoize the play function to ensure stable reference
    ...
    // Memoize submit_pinyin to pass a stable reference to InputArea,
    // which prevents InputArea from re-rendering every time the Chat component's messages state updates.
