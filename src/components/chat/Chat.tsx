...
export default function Chat() {
    ...
    // Stabilize reference to prevent unnecessary re-renders in InputArea
    ...
    // Stabilize reference to ensure onSendMessage prop passed to InputArea remains stable across re-renders
    // This is especially important since Chat frequently re-renders on backend audio events.
