...
export default function Chat() {
    ...
    // This creates a stable reference to prevent unnecessary re-renders of child components
    // when the Chat component re-renders due to message state updates.
    ...
    // This creates a stable reference to prevent the InputArea from re-rendering frequently
    // during tts-finished and audio-played events.
