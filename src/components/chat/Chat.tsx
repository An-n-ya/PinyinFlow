...
// Move pure async function outside component to avoid recreation on every render
...
export default function Chat() {
    ...
    // Memoize submit handler to prevent InputArea re-renders when Chat state updates
