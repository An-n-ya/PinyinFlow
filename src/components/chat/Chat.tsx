...
export default function Chat() {
    ...
    // ⚡ Bolt: Memoized with useCallback to maintain stable reference for InputArea's submit_pinyin prop
    ...
    const submit_pinyin = useCallback(
        // ⚡ Bolt: Memoized with useCallback so InputArea (wrapped in React.memo) receives a stable reference, preventing re-renders.
        async (pinyin: string) => {
