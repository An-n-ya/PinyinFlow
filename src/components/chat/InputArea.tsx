...
// ⚡ Bolt: Wrap in React.memo to skip expensive DOM re-renders when parent chat state
// updates (like new messages arriving), relying on a stable `onSendMessage` callback prop.
