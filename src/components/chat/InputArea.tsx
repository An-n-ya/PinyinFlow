...
// ⚡ Bolt: Wrapped InputArea in React.memo to prevent unnecessary re-renders when
// the parent Chat component's `messages` state updates frequently (e.g., 'tts-finished', 'audio-played').
// This requires `onSendMessage` to be wrapped in useCallback in the parent component to keep its reference stable.
