...
// Memoize InputArea to prevent unnecessary re-renders when the parent Chat component's
// messages state updates frequently due to backend events (e.g., tts-finished, audio-played).
