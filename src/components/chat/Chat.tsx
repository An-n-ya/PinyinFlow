...
export default function Chat() {
    ...
    // useCallback is used to keep function references stable across Chat component re-renders.
    // This is necessary because InputArea is wrapped in React.memo and takes onSendMessage as a prop.
    // Without useCallback, InputArea would re-render every time Chat's `messages` state changes.
