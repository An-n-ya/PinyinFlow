...
// Wrapped in React.memo to prevent unnecessary re-renders when parent Chat component
// updates messages state (which happens frequently via tts-finished/audio-played events)
