...
export default function Chat() {
    ...
    // ⚡ Bolt Optimization: Wrapped play in useCallback
    // Why: Provides a stable reference so submit_pinyin doesn't change on every render.
    ...
    // ⚡ Bolt Optimization: Wrapped submit_pinyin in useCallback
    // Why: Ensures the onSendMessage prop passed to InputArea remains stable,
    // which allows InputArea's React.memo to prevent unnecessary re-renders.
