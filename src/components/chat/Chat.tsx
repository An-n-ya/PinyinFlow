...
export default function Chat() {
    ...
    // Performance Optimization: Wrap play in useCallback to maintain a stable reference
    // when passed to submit_pinyin, preventing unnecessary re-renders of InputArea.
    ...
    // Performance Optimization: Wrap submit_pinyin in useCallback to maintain a stable
    // reference when passed to InputArea, preventing unnecessary re-renders of InputArea
    // when Chat component's state changes frequently (e.g. from backend events).
