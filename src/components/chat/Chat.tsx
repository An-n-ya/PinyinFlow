...
export default function Chat() {
    ...
    // Memoize the play function to provide stable references for submit_pinyin
    ...
    // Memoize submit_pinyin to pass stable prop reference to InputArea.
    // This optimization is necessary to prevent unnecessary re-renders of InputArea
    // when messages state updates frequently due to Tauri backend events (tts-finished, audio-played).
