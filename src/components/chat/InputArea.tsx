...
// Wrapped in memo to prevent unnecessary re-renders when parent Chat component state updates
// (e.g. from frequent TTS or audio events updating the message list).
