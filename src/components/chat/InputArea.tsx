...
// Wrapped in React.memo to prevent unnecessary re-renders when the parent Chat
// component's messages state updates (e.g. from tts-finished or audio-played events)
