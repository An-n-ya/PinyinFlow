...
export default function Chat() {
    ...
    // ⚡ Bolt: Memoize play function to prevent unnecessary re-renders of child components
    ...
    // ⚡ Bolt: Memoize submit handler so its reference is stable, allowing InputArea to be memoized
