...
export default function Chat() {
    ...
    // Stable callback to maintain the React.memo optimization of the InputArea child component
    // during frequent `messages` state updates triggered by backend events.
