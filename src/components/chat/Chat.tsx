...
// ⚡ Bolt: Moved play outside of component to ensure stable reference and prevent recreation
...
export default function Chat() {
    ...
    // ⚡ Bolt: Wrapped submit_pinyin in useCallback to provide stable reference to InputArea.
    // This allows InputArea's React.memo to correctly prevent unnecessary re-renders when Chat's message state updates.
    const submit_pinyin = React.useCallback(async (pinyin: string) => {
