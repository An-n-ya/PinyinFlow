...
export default function Chat() {
    ...
    // ⚡ Bolt: Memoize the play function to maintain a stable reference across re-renders
    // This is a dependency for submit_pinyin.
    ...
    const submit_pinyin = useCallback(
        // ⚡ Bolt: Memoize submit_pinyin so we can pass a stable reference to the InputArea
        // component, preventing it from unnecessarily re-rendering on every message update.
        async (pinyin: string) => {
