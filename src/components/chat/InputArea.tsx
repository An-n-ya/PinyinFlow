...
import { KeyboardEvent as ReactKeyboardEvent, memo, useRef, useState } from 'react';
...
// Memoized to prevent re-renders when parent Chat component updates (e.g. audio playback)
