...
// Wrapped in memo to prevent unnecessary re-renders during frequent `messages`
// state updates triggered by backend events (e.g. `tts-finished`, `audio-played`) in parent.
