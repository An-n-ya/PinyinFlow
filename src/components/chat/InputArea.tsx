...
// ⚡ Bolt: Wrap InputArea in React.memo so it only re-renders when its props change.
// When combined with useCallback on onSendMessage in the parent, this prevents
// re-renders of the input area whenever the parent's message list updates.
